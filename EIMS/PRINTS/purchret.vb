...
Module purchret
    ...
    Public Sub return_print(ByVal slno As Integer)
        ret_no = slno
        Call datastore()
    ...
    Private Sub datastore()
        ...
        If ds1.Tables(0).Rows.Count <> 0 Then
            For i As Integer = 0 To ds1.Tables(0).Rows.Count - 1
                ...
                retamt = ds1.Tables(0).Rows(i).Item("pret_amt")
