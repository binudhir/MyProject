...
Public Class rep_colreg
    ...
    Private Sub clr()
        Me.Text = "Collection Register(Scheduled) . . ."
        hddr = Me.Text
        txtsesncd.Text = 0
        txtstrmcd.Text = 0
        txtacdncd.Text = 0
    ...
    Private Sub btnview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnview.Click
        ...
        If ds.Tables(0).Rows.Count <> 0 Then
            ...
            If Val(tot_coll) <> 0 Then
                ...
                rw = rw + 1
            End If
            GroupBox3.Text = "Student Collection Register From (Scheduled)" & startdt.Value & " To " & enddt.Value
            hddr = GroupBox3.Text
