...
Public Class frmpurch
    Dim comd As String = "E"
    Private allowCoolMove As Boolean = False
    Private myCoolPoint As New Point
#Region "Start Up"
    Private Sub frmpurch_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        cnfr = MessageBox.Show("Are You Sure To Close The Screen", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1)
        If cnfr = vbYes Then
            e.Cancel = False
            MDI.mnucashcrpurch.Enabled = True
        Else
            e.Cancel = True
        End If
    End Sub

    Private Sub frmpurch_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
            Me.Close()
        End If
    End Sub

    Private Sub frmpurch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        MDI.mnucashcrpurch.Enabled = False
        Me.clr()
    ...
    Private Sub frmpurch_SizeChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.SizeChanged
    ...
    Private Sub clr()
        ...
        lrdt.Value = sys_date
        If comd = "E" Then
            Me.Text = "Cash / Credit Purchase Entry Screen...."
            ...
            btnsave.Text = "Save"
        ElseIf comd = "M" Then
            Me.Text = "Cash / Credit Purchase Modification Screen...."
            txtscroll.Text = ""
            btnsave.Text = "Modify"
        Else
            Me.Text = "Cash / Credit Purchase Deletion Screen...."
            txtscroll.Text = ""
            btnsave.Text = "Delete"
        End If
        Me.clr1()
...
#Region "Enter/Leave"
    ...
    Private Sub sender_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtscroll.Enter, txtslno.Enter, txtquantity.Enter, txtfree.Enter, txtmrp.Enter, txtprtcd.Enter, txtrate.Enter, txtamount.Enter, txtcoper.Enter, txtcoamt.Enter, txttrper.Enter, txttramt.Enter, txtmrvalue.Enter, txttto.Enter, txtadisc.Enter, txtacharg.Enter, txttotal.Enter, txtnb.Enter, txtchargamt.Enter, txtadisc.Enter, cmbparty.Enter, cmbstore.Enter, cmbproduct.Enter, cmbfrom.Enter, cmbpr.Enter, cmbpurtype.Enter, cmbtr.Enter, recdt.Enter, paydt.Enter, invdt.Enter, txtinvno.Enter, txtchno.Enter, txtvehno.Enter, txtlrno.Enter, txtwaypfx.Enter, txtwbno.Enter, cmbbatch.Enter, cmbunit.Enter, txtdiscamt.Enter, txttaxstl.Enter, cmbcgst.Enter, cmbsgst.Enter, txtcgst.Enter, txtsgst.Enter
        sender.forecolor = Color.Blue
        sender.backcolor = Color.LavenderBlush
    End Sub

    Private Sub sender_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtscroll.Leave, txtslno.Leave, txtquantity.Leave, txtfree.Leave, txtmrp.Leave, txtprtcd.Leave, txtrate.Leave, txtamount.Leave, txtcoper.Leave, txtcoamt.Leave, txttrper.Leave, txttramt.Leave, txtmrvalue.Leave, txttto.Leave, txtadisc.Leave, txtacharg.Leave, txttotal.Leave, txtnb.Leave, txtchargamt.Leave, txtadisc.Leave, cmbparty.Leave, cmbstore.Leave, cmbproduct.Leave, cmbfrom.Leave, cmbpr.Leave, cmbpurtype.Leave, cmbtr.Leave, recdt.Leave, paydt.Leave, invdt.Leave, txtinvno.Leave, txtchno.Leave, txtvehno.Leave, txtlrno.Leave, txtwaypfx.Leave, txtwbno.Leave, cmbbatch.Leave, cmbunit.Leave, txtdiscamt.Leave, txttaxstl.Leave, cmbcgst.Enter, cmbsgst.Enter, txtcgst.Enter, txtsgst.Enter
...
#Region "Key Press"
    ...
    Private Sub cmbvat_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
...
#Region "Combo Box"
    ...
    Private Sub cmbparty_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbparty.Validated
        Dim ds As DataSet = get_dataset("SELECT in_out,prt_code,add1,lim_day,cl_amt FROM party WHERE pname='" & Trim(cmbparty.Text) & "'")
        If ds.Tables(0).Rows.Count <> 0 Then
    ...
    Private Sub cmbproduct_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbproduct.Validated
        ...
        If ds.Tables(0).Rows.Count <> 0 Then
            ...
            cmbsgst.Text = "0"
            If vb.Left(cmbfrom.Text, 1) = "I" Then
    ...
    Private Sub cmbcgst_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbcgst.GotFocus, cmbsgst.GotFocus
        ...
        txtsgst.Text = "0.00"
        txtvatper.Text = 0
        populate(cmbcgst, "SELECT txname FROM taxper WHERE (rec_lock = 'N') ORDER BY txname")
    End Sub

    Private Sub cmbvat_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        txtcgst.Text = "0.00"
        txtsgst.Text = "0.00"
        txtvatper.Text = 0
...
#Region "Data save"
    Private Sub purchase_save()
        ...
        igst = 0
        If vb.Left(cmbfrom.Text, 1) = "O" Then
            cgst = 0
        ...
        If comd = "E" Then
            ...
            If cnfr = vbYes Then
                ...
                SQLInsert("INSERT INTO purch1 (pur_no,pur_dt,prt_code,chal_no,chal_dt,inv_no,inv_dt,way_bno,trk_no,pur_type,pur_of," & _
                          ...
                          "usedby,way_chr,godsl,cgsttot,sgsttot,igsttot) VALUES (" & Val(txtscroll.Text) & ",'" & Format(recdt.Value, "dd/MMM/yyyy") & "'," & _
                          ...
                          Trim(txtvehno.Text) & "','" & vb.Left(cmbpurtype.Text, 1) & "','" & vb.Left(cmbfrom.Text, 1) & "'," & _
                          ...
                          Trim(txtwaypfx.Text) & "'," & Val(txtgodcd.Text) & "," & cgst & "," & Val(lblsgsttot.Text) & "," & igst & ")")
                Me.dv_save()
            ...
            If cnfr = vbYes Then
                ...
                If ds.Tables(0).Rows.Count <> 0 Then
                    SQLInsert("UPDATE purch1 SET pur_dt='" & Format(recdt.Value, "dd/MMM/yyyy") & "',prt_code=" & Val(txtprtcd.Text) & ",chal_no='" & _
                          ...
                          vb.Left(cmbpurtype.Text, 1) & "',pur_of='" & vb.Left(cmbfrom.Text, 1) & "',dv_tot=" & Val(lbltotal.Text) & ",pur_amt=" & _
                          Val(txtgrtotal.Text) & ",way_chr='" & Trim(txtwaypfx.Text) & "',dis_amt=" & Val(txtdiscamt.Text) & ",chr_amt=" & _
                          Val(txtchargamt.Text) & ",cgsttot=" & cgst & ",sgsttot=" & Val(lblsgsttot.Text) & ",igsttot=" & igst & ",nb='" & Trim(txtnb.Text) & "',paydt='" & Format(paydt.Value, "dd/MMM/yyyy") & "',lr_no='" & _
        ...
        If dv1.RowCount <> 0 Then
            ...
            For i As Integer = 0 To dv1.RowCount - 1
                ...
                SQLInsert("INSERT INTO purch2 (pur_sl,pur_no,pur_dt,prt_code,it_cd,godsl,bat_cd,pur_rt,pur_qty,it_amt,tto_amt,tax_cd,oth_amt,disc_amt,it_tot," & _
                          ...
                          "mrp_amt,bit_type,  bdisc_amt,cgstper,cgstamt,sgstper,sgstamt,igstper,igstamt) VALUES (" & Val(mxno) & "," & Val(txtscroll.Text) & ",'" & Format(recdt.Value, "dd/MMM/yyyy") & "'," & _
                          Val(txtprtcd.Text) & "," & Val(itcd) & "," & Val(txtgodcd.Text) & "," & Val(batcd) & "," & it_rt & "," & qty & "," & amt & "," & tto & "," & taxcd & "," & _
                          achrg & "," & adisc & "," & total & "," & cgstamt & "," & mrp & "," & exmrp & ",0,'" & vb.Left(prdtp, 1) & "','" & _
                          vb.Left(trtp, 1) & "','" & unt & "'," & free & "," & mulrt & "," & codisper & "," & trdisper & "," & codisamt & "," & trdisamt & "," & _
                          mrval & ",'" & taxcat & "'," & codisamt + trdisamt & "," & cgst & "," & cgstamt & "," & sgst & "," & sgstamt & "," & igst & "," & igstamt & ")")
                'If txtbatcnfr.Text = "S" Then
                ...
                '    SQLInsert("UPDATE batno SET rec_stk=rec_stk +" & itqt & ",cl_stk=cl_stk +" & itqt & " WHERE it_cd=" & Val(itcd) & " AND bat_cd=" & (batcd) & "")
                'Else
                '    SQLInsert("UPDATE item SET drec_stk=drec_stk +" & itqt & ",dcl_stk=dcl_stk +" & itqt & " WHERE it_cd=" & Val(itcd) & "")
                '    SQLInsert("UPDATE batno SET drec_stk=drec_stk +" & itqt & ",dcl_stk=dcl_stk +" & itqt & " WHERE it_cd=" & Val(itcd) & " AND bat_cd=" & (batcd) & "")
                'End If
            Next
        End If
    End Sub
    ...
    Private Sub srl_save(ByVal pursl As Integer, ByVal it_cd As Integer)
        If dvsl1.RowCount <> 0 Then
            SQLInsert("DELETE FROM pur_slno WHERE pur_sl=" & Val(pursl) & "")
            For m As Integer = 0 To dvsl1.RowCount - 1
                ...
                If Val(itcd) = Val(it_cd) Then
                    ...
                    SQLInsert("INSERT INTO pur_slno (sl_slno,it_cd,pur_no,pur_sl) VALUES (" & Val(mxno) & "," & itcd & "," & Val(txtscroll.Text) & "," & Val(pursl) & ")")
                End If
            Next
        End If
    End Sub
...
#Region "Calculation"
    Private Sub dv_calc()
        ...
        If Val(txtquantity.Text) <> 0 Or Val(frqt) <> 0 Then
            ...
            '    vatfr = Val((Val(gstper) / 100) * Val(puramt))
            'End If
...
#Region "Data Retrieve"
    ...
    Private Sub dv_view()
        ...
        If ds.Tables(0).Rows.Count <> 0 Then
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                ...
                dv1.Rows(rw).Cells(30).Value = ds.Tables(0).Rows(i).Item("pur_sl")
                rw += 1
                'If txtbatcnfr.Text = "S" Then
    ...
    Private Sub srl_view(ByVal pursl As Integer)
        Dim ds2 As DataSet = get_dataset("SELECT mast_slno.slno, pur_slno.* FROM pur_slno LEFT OUTER JOIN mast_slno ON pur_slno.sl_slno = mast_slno.sl_slno WHERE pur_slno.pur_sl=" & pursl & "")
...
#End Region
    ...
    Private Sub txtvat_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtmrp.Validated, txtacharg.Validated, txtadisc.Validated
        Me.dv_calc()
    End Sub
    ...
    Private Sub del2(ByVal code As Integer)
        Dim dsdel As DataSet = get_dataset("SELECT pur_sl,pur_qty,it_cd,bat_cd,free_qty,mul_rt,prd_tp,tr_tp  FROM purch2 WHERE pur_no=" & Val(code) & "")
        If dsdel.Tables(0).Rows.Count <> 0 Then
    ...
    Private Sub Set_view()
        ...
        chksetblrnd.Checked = False
        chksetcodisc.Checked = False
        Dim ds As DataSet = get_dataset("SELECT * FROM setting_purch WHERE slno=1")
        If ds.Tables(0).Rows.Count <> 0 Then
...
#End Region
    ...
    Private Sub cmbfrom_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbfrom.TextChanged
