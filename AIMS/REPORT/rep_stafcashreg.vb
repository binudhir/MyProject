...
Public Class rep_stafcashreg
    Dim comd As String

    Private Sub rep_stafcashreg_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub rep_stafcashreg_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
            Me.Close()
        End If
    End Sub

    Private Sub rep_stafcashreg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub clr()
        Me.Text = "Staff Wise Cash Sales Register . . ."
        hddr = Me.Text
        txtordcd.Text = 0
        txtpartycd.Text = 0
        txtstafcd.Text = 0
...
#Region "Enter/Leave"
    Private Sub cmbregist_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbstaf.Enter, cmbparty.Enter, cmbreg.Enter
        sender.forecolor = Color.Blue
        sender.backcolor = Color.LavenderBlush

    End Sub

    Private Sub cmbregist_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbstaf.Leave, cmbparty.Leave, cmbreg.Leave
...
#Region "combobox"
    Private Sub cmbstaf_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbstaf.GotFocus
        txtstafcd.Text = 0
        populate(cmbstaf, "SELECT staf_nm FROM staf WHERE (rec_lock = 'N') ORDER BY staf_nm")
    End Sub
    ...
    Private Sub cmbstaf_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbstaf.Validating
        vdating(cmbstaf, "SELECT staf_nm FROM staf WHERE (staf_nm = '" & Trim(cmbstaf.Text) & "')", "Please Select a Valid Product Name.")
    End Sub

    Private Sub cmbstaf_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbstaf.Validated
        vdated(txtstafcd, "SELECT staf_sl FROM staf WHERE (staf_nm = '" & Trim(cmbstaf.Text) & "')")
    End Sub
...
#End Region
    ...
    Private Sub btnview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnview.Click
        ...
        If chkstaf.Checked = False Then
            conditn = conditn & "AND (item.it_cd=" & Val(txtstafcd.Text) & ")"
        End If
...
#Region "checkBox"
    ...
    Private Sub chkprod_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkstaf.CheckedChanged
        If chkstaf.Checked = True Then
            cmbstaf.Text = "<<< All Staff >>>"
...
#Region "keypress"
    ...
    Private Sub chkstaf_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles chkstaf.KeyPress
        key(btnview, e)
    End Sub
