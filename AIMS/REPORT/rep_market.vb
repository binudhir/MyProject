...
Public Class rep_market
    Dim comd As String

    Private Sub rep_market_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub rep_market_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
            Me.Close()
        End If
    End Sub

    Private Sub rep_market_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub clr()
        Me.Text = "Market Wise Cash Sales Register . . ."
        hddr = Me.Text
        txtordcd.Text = 0
        txtmarkcd.Text = 0
        txtprodcd.Text = 0
...
#Region "Enter/Leave"
    Private Sub cmbregist_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbprod.Enter, cmbmarket.Enter, cmbreg.Enter
        sender.forecolor = Color.Blue
        sender.backcolor = Color.LavenderBlush

    End Sub

    Private Sub cmbregist_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbprod.Leave, cmbmarket.Leave, cmbreg.Leave
...
#End Region
    ...
    Private Sub btnview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnview.Click
        ...
        If chkmark.Checked = False Then
            conditn = " AND (party.prt_code=" & Val(txtmarkcd.Text) & ")"
        End If
...
#Region "checkBox"
    ...
    Private Sub chkparty_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkmark.CheckedChanged
...
#Region "keypress"
    ...
    Private Sub chkmark_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles chkmark.KeyPress
        key(cmbprod, e)
    End Sub
