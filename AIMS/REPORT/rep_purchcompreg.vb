...
Public Class rep_purchcompreg
    Dim comd As String

    Private Sub rep_purchcompreg_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub rep_purchcompreg_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
            Me.Close()
        End If
    End Sub

    Private Sub rep_purchcompreg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub clr()
        Me.Text = "Purchase Register (Comp Wise) . . ."
        hddr = Me.Text
        txtcompcd.Text = 0
        cmbcompany.Text = ""
...
#Region "keypress"
    ...
    Private Sub chkcomp_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles chkcomp.KeyPress
        key(btnview, e)
    End Sub
#End Region
End Class
