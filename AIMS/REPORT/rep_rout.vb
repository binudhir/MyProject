...
Public Class rep_rout
    Dim comd As String

    Private Sub rep_rout_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub rep_rout_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
            Me.Close()
        End If
    End Sub

    Private Sub rep_rout_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub clr()
        Me.Text = "Rout Wise Cash Sales Register . . ."
        hddr = Me.Text
        txtordcd.Text = 0
        txtroutcd.Text = 0
        txtprodcd.Text = 0
...
#Region "Enter/Leave"
    Private Sub cmbregist_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbprod.Enter, cmbrout.Enter, cmbreg.Enter
        sender.forecolor = Color.Blue
        sender.backcolor = Color.LavenderBlush

    End Sub

    Private Sub cmbregist_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbprod.Leave, cmbrout.Leave, cmbreg.Leave
...
#Region "combobox"
    ...
    Private Sub cmbrout_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbrout.GotFocus
        cmbrout.Height = 100
        populate(cmbrout, "SELECT rt_nm FROM rout ORDER BY rt_nm")
    End Sub

    Private Sub cmbrout_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbrout.LostFocus
        cmbrout.Height = 21
    End Sub
    Private Sub cmbrout_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbrout.Validated
        vdated(txtroutcd, "SELECT rt_cd FROM rout WHERE rt_nm='" & Trim(cmbrout.Text) & "'")
    End Sub

    Private Sub cmbrout_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbrout.Validating
        vdating(cmbrout, "SELECT rt_nm FROM rout WHERE rt_nm='" & Trim(cmbrout.Text) & "'", "Please Select A Market Name.")
    End Sub
#End Region
    ...
    Private Sub btnview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnview.Click
        ...
        Dim ds As DataSet
        conditn = ""
        If chkrout.Checked = False Then
            conditn = " AND (party.prt_code=" & Val(txtroutcd.Text) & ")"
        End If
...
#Region "checkBox"
    ...
    Private Sub chkparty_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkrout.CheckedChanged
        If chkrout.Checked = True Then
            cmbrout.Text = "<<< All Rout >>>"
            cmbrout.Enabled = False
            txtroutcd.Text = 0
        Else
            cmbrout.Text = ""
            cmbrout.Enabled = True
            cmbrout.Focus()
        End If
    End Sub
...
#Region "keypress"
    ...
    Private Sub cmbrout_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cmbrout.KeyPress
        key(chkrout, e)
        SPKey(e)
    End Sub

    Private Sub chkrout_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles chkrout.KeyPress
        key(cmbprod, e)
    End Sub
