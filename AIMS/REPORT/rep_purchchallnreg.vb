...
Public Class rep_purchchallnreg
    Dim comd As String

    Private Sub rep_purchchallnreg_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub rep_purchchallnreg_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
            Me.Close()
        End If
    End Sub

    Private Sub rep_purchchallnreg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub clr()
        Me.Text = "Purchage Challan Register . . ."
        hddr = Me.Text
        txtordcd.Text = 0
        txtpartycd.Text = 0
        txtprodcd.Text = 0
...
#Region "Enter/Leave"
    ...
    Private Sub startdt_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles startdt.Enter, enddt.Enter, cmbreg.Enter, cmbprod.Enter, cmbparty.Enter
        sender.forecolor = Color.Blue
        sender.backcolor = Color.LavenderBlush

    End Sub

    Private Sub startdt_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles startdt.Leave, enddt.Leave, cmbreg.Leave, cmbprod.Leave, cmbparty.Leave
...
#End Region
    ...
    Private Sub btnview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnview.Click
        ...
        If ds.Tables(0).Rows.Count <> 0 Then
            ...
            GroupBox3.Text = "Purchase Order Register From " & startdt.Value & " To " & enddt.Value
            hddr = GroupBox3.Text
        Else
            lblmsg.Visible = True
        End If
