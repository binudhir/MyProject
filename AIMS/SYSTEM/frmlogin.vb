...
Public Class frmlogin
    ...
    Private Sub btnlogin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlogin.Click
        If Trim(txtunm.Text) <> "" Then
            ...
            End If
        Else
            MessageBox.Show("Please Provide An User Name.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            txtunm.Focus()
            Exit Sub
        End If
        If logn = "Y" Then
    ...
    Private Sub sender_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs)
        sender.ForeColor = Color.Blue
    End Sub

    Private Sub Cancel_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs)
        sender.ForeColor = Color.Black
    End Sub
